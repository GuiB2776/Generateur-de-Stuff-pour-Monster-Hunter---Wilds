...
function updateTotals() {
  ...
  const display = `
    <span class="def">Défense : ${stats.defense}</span> |
    <span class="feu">Feu : ${stats.feu}</span> |
    <span class="eau">Eau : ${stats.eau}</span> |
    <span class="foudre">Foudre : ${stats.foudre}</span> |
    <span class="glace">Glace : ${stats.glace}</span> |
    <span class="dragon">Dragon : ${stats.dragon}</span>`;
...
function calcSetStats(parts) {
  ...
  return `
    <span class="def">DEF: ${total.defense}</span> |
    <span class="feu">Feu: ${total.feu}</span> |
    <span class="eau">Eau: ${total.eau}</span> |
    <span class="foudre">Foudre: ${total.foudre}</span> |
    <span class="glace">Glace: ${total.glace}</span> |
    <span class="dragon">Dragon: ${total.dragon}</span>`;
}
